...
function download() {
    USER_HOME="$1"
    echo "Desinstalando downloader script"
...
function gvapi() {
    USER_HOME="$1"
    echo "Desinstalando gvapi script"
...
function gtextcommand {
    USER_HOME="$1"
    echo "Desinstalando gtextcommand script"
...
function youtube() {
    USER_HOME="$1"
    echo "Desinstalando youtube scripts"
...
function voicecommand() {
    echo "Desinstalando voicecommand scripts"
