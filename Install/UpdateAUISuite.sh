...
if [ -e "/usr/bin/gtextcommand" ] ; then
    echo "Actualizando gtextcommand ..."
...
if [ -e "/usr/bin/voicecommand" ] ; then
    echo "Actualizando voicecommand ..."
...
if [ -n "$difference" ] ; then
    echo "Encontré una nueva versión del script de actualización"
